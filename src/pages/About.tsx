  ...
  return (
    <AboutWrapper>
      <HeroSection ref={heroRef}>
        ...
        <LogoContainer>
          <MainLogo>DESIGNECOURSES</MainLogo>
        </LogoContainer>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('DESIGNECOURSES')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower learners worldwide with cutting-edge web design education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform design concepts into practical skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted web design courses cover UI/UX design, responsive layouts, modern CSS frameworks, JavaScript interactions, and more. Each course is designed with hands-on projects, real-world applications, and industry best practices to help you master web design and advance your career in this creative field.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Web Design Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive web design learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
              ...
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                <LeaderInfo style={{padding: '40px', textAlign: 'center'}}>
                  ...
                  <LeaderDescription>
                    ...
                    Creates comprehensive video courses to help others learn and master the fascinating world of web design.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Design Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in web design education, constantly updating 
                  our curriculum with the latest design trends and industry best practices.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Web design should be accessible to everyone. We create a supportive environment 
                  where learners from all backgrounds can master design fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Design Practices</ValueTitle>
                <ValueDescription>
                  We stay current with the latest design trends and tools, 
                  bringing modern design practices directly to our students.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(31)}>
                <ValueIcon>🛡️</ValueIcon>
                <ValueTitle>Clean Design Principles</ValueTitle>
                <ValueDescription>
                  We prioritize clean, user-friendly design, teaching not just how to 
                  create beautiful interfaces, but how to build them efficiently and professionally.
                </ValueDescription>
              </ValueCard>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalDescription>
            We are the creators of DesignEcourses - a comprehensive web design education platform. Our mission is to make professional web design accessible to everyone.
            <br /><br />
            We believe web design should be accessible to everyone, not just those with advanced technical backgrounds. That's why we 
            created comprehensive video courses that break down complex design concepts into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of web design and empower them 
            with the knowledge and skills needed to create beautiful websites and advance their careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your web design journey or looking to master advanced design concepts, we're here to guide you every step 
            of the way. Let's explore the incredible possibilities of web design together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
